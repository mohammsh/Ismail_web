    ...
    <div className="p-6 max-w-5xl mx-auto bg-gradient-to-r from-purple-100 to-indigo-200 rounded-lg shadow-2xl">
      ...
      <div className="my-8 relative">
        ...
        <p className="mb-4 text-base text-gray-700 leading-snug">
            All ISM Incidents/Events must be reported to your Company Division's ISMP/PIP representative to file an Incident Report. <br />
            Your ISMP will work with you to fill the ISM Report.
        </p>
