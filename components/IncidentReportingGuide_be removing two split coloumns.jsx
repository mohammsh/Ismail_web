  ...
  return (
    <div className="p-6 max-w-5xl mx-auto bg-gradient-to-r from-purple-100 to-indigo-200 rounded-lg shadow-2xl">
      ...
      <div className="my-8 relative">
        ...
        <p className="mb-4 text-base text-gray-700 leading-snug">
        All ISM Incidents/Events must be reported to your Company ISM Manager/professional or PIP representative to file an ISM Report. Your ISMP will work with you to fill the ISM Report:
        </p>
        <ol className="space-y-0.5 text-sm text-gray-700 leading-snug">
      ...
      <div className="bg-indigo-100 p-6 rounded-lg shadow-lg">
        ...
        <p className="mb-4 text-base text-gray-700 leading-tight">
        Contact your ISM Manager/Professional or PIP representative to file an ISM Report:
        </p>
