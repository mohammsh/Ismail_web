        ...
        <div className='flex justify-between gap-x-8'>
          ...
          <div className='hidden xl:flex relative'>
            ...
            <Badge
              ...
              icon={<RiTeamFill className="text-primary dark:text-secondary text-3xl"/>}
              //endCountNum={5}
              //endCountText='India'
              badgeText='India'
            />
              <Badge
              containerStyles='absolute top-[30%] -right-14 flex flex-col items-center justify-center w-[150px] h-[100px] bg-white rounded-md'
              icon={<RiTeamFill className="text-primary text-lg" />}
              //endCountNum={5}
              //endCountText='Australia'
              badgeText={<span className="text-xs font-semibold text-center">Australia</span>}
            />
              <Badge
              containerStyles='absolute top-[15%] -right-14 flex flex-col items-center justify-center w-[10px] h-[1+-0px] bg-white dark:bg-background shadow-md rounded-md'
              icon={<RiTeamFill />}
              //endCountNum={5}
            ...
            />
              <Badge
              containerStyles='absolute top-[60%] -right-14'
              icon={<MapPin />}
              //endCountNum={5}
              //endCountText='Spain'
              badgeText='Spain'
            />
              <Badge
              containerStyles='absolute top-[75%] -right-14'
              icon={<MapPin />}
              //endCountNum={5}
              //endCountText='Canada'
              badgeText='Canada'
            />
              <Badge
              containerStyles='absolute top-[90%] -right-14 w-[15px] h-[10px]'
              icon={<MapPinnedIcon />}
              badgeText='USA'
            />
